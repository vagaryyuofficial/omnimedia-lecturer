...
export type LanguageCode = "CN" | "EN" | "FR" | "DE";
...
export const CURRICULUM: Record<SubjectId, CurriculumLevel[]> = {
  literature: [
    { id: "L1", name: "基础", en: "Foundation", descriptor: "作品、体裁与阅读方法", topics: ["短篇小说：叙述者与视角", "十四行诗：格律与转折", "亚里士多德：悲剧与净化"] },
    { id: "L2", name: "进阶", en: "Genre", descriptor: "文类、修辞与跨语翻译", topics: ["浮士德：Streben 与现代性", "象征主义：意象的多义性", "世界文学：流通与翻译"] },
    { id: "L3", name: "高阶", en: "Theory", descriptor: "形式主义、符号学与批评", topics: ["俄国形式主义：陌生化", "符号学：能指与所指", "后殖民阅读：中心与边缘"] },
  ],
  economics: [
    { id: "L1", name: "基础", en: "Foundation", descriptor: "选择、价格与市场", topics: ["稀缺与机会成本", "供给、需求与均衡", "比较优势与贸易"] },
    { id: "L2", name: "核心", en: "Policy", descriptor: "宏观政策与制度", topics: ["通胀、预期与货币", "失业与经济周期", "财政政策与公共债务"] },
    { id: "L3", name: "高阶", en: "Frontier", descriptor: "博弈、行为与全球治理", topics: ["纳什均衡与策略互动", "行为经济学与助推", "Debt、dette 与 Schulden"] },
  ],
  psychology: [
    { id: "L1", name: "基础", en: "Foundation", descriptor: "行为、认知与研究方法", topics: ["经典条件反射", "记忆与注意", "实验、相关与因果"] },
    { id: "L2", name: "核心", en: "Clinical", descriptor: "人格、发展与临床概念", topics: ["Es / Ich / Über-Ich", "依恋与发展", "认知行为疗法"] },
    { id: "L3", name: "高阶", en: "Theory", descriptor: "精神分析与社会心理", topics: ["拉康：镜像与大他者", "群体、服从与从众", "自我叙事与身份"] },
  ],
  business: [
    { id: "L1", name: "基础", en: "Foundation", descriptor: "清晰、礼貌与执行", topics: ["商务邮件的行动结构", "会议主持与纪要", "反馈与困难对话"] },
    { id: "L2", name: "核心", en: "Strategy", descriptor: "协作、谈判与管理", topics: ["多国谈判与锚定", "敏捷管理与复盘", "品牌定位与价值主张"] },
    { id: "L3", name: "高阶", en: "Executive", descriptor: "跨文化领导与决策", topics: ["董事会叙事与修辞", "危机沟通与信任", "跨文化领导力"] },
  ],
  daily: [
    { id: "L1", name: "基础", en: "Foundation", descriptor: "抵达、询问与生存", topics: ["欧洲交通与问路", "餐厅点单与过敏说明", "酒店与紧急求助"] },
    { id: "L2", name: "核心", en: "Lifestyle", descriptor: "居住、医疗与行政", topics: ["租房合同与押金", "看病、症状与处方", "银行、税务与行政"] },
    { id: "L3", name: "高阶", en: "Culture", descriptor: "习俗、俚语与文化语感", topics: ["米其林与法餐术语", "德语区礼仪与界限", "英法德俚语的分寸"] },
  ],
  art: [
    { id: "L1", name: "基础", en: "Foundation", descriptor: "观看、构图与材料", topics: ["构图与视觉重心", "色彩、明度与空间", "媒介、笔触与肌理"] },
    { id: "L2", name: "核心", en: "History", descriptor: "流派与视觉制度", topics: ["文艺复兴与透视", "印象派的光与时间", "现代主义与抽象"] },
    { id: "L3", name: "高阶", en: "Criticism", descriptor: "美学、制度与批评", topics: ["黄金分割的神话与事实", "康德：无利害的愉悦", "黑格尔与艺术终结论"] },
  ],
  philosophy: [
    { id: "L1", name: "基础", en: "Foundation", descriptor: "论证、概念与古典问题", topics: ["苏格拉底式追问", "柏拉图：理念与洞穴", "亚里士多德：四因说"] },
    { id: "L2", name: "核心", en: "Logic", descriptor: "认识、伦理与辩证法", topics: ["康德：先验与物自体", "黑格尔：Aufhebung", "功利主义与义务论"] },
    { id: "L3", name: "高阶", en: "Existence", descriptor: "现象学与存在主义", topics: ["海德格尔：Dasein", "萨特：存在与虚无", "语言哲学与生活形式"] },
  ],
  science: [
    { id: "L1", name: "基础", en: "Foundation", descriptor: "算法、物理与系统", topics: ["算法与计算复杂度", "逻辑门与二进制", "经典力学与建模"] },
    { id: "L2", name: "核心", en: "Engineering", descriptor: "网络、数据与架构", topics: ["分布式系统与共识", "云架构与弹性", "神经网络与反向传播"] },
    { id: "L3", name: "高阶", en: "Frontier", descriptor: "前沿理论与技术伦理", topics: ["量子叠加与测量", "大模型与涌现能力", "技术风险与可解释性"] },
  ],
};

const VISUALS = {
  freud: { src: "/gallery/freud.jpg", title: "Sigmund Freud, 1926", caption: "Ferdinand Schmutzer 摄影；精神分析术语的历史语境。", sourceUrl: "https://commons.wikimedia.org/wiki/File:Sigmund_Freud_1926_(cropped).jpg", sourceLabel: "Wikimedia Commons · Public Domain" },
  eniac: { src: "/gallery/eniac.jpg", title: "Programming the ENIAC", caption: "早期电子计算机与“程序”概念的物质形态。", sourceUrl: "https://commons.wikimedia.org/wiki/File:Eniac_(cropped).jpg", sourceLabel: "U.S. Army · Public Domain" },
  monet: { src: "/gallery/monet.jpg", title: "Water Lilies, 1906", caption: "莫奈以连续观看松动固有色与物体边界。", sourceUrl: "https://commons.wikimedia.org/wiki/File:Monet%27s_Water_Lilies.jpg", sourceLabel: "Wikimedia Commons · Public Domain" },
  michelin: { src: "/gallery/michelin.jpg", title: "Le Guide Michelin, 1900", caption: "旅行基础设施如何塑造现代餐饮语言与消费文化。", sourceUrl: "https://commons.wikimedia.org/wiki/File:Guidem_michelin_1900.jpg", sourceLabel: "Wikimedia Commons · Public Domain" },
  athens: { src: "/gallery/athens.jpg", title: "The School of Athens", caption: "拉斐尔用透视结构安排古典知识的谱系。", sourceUrl: "https://commons.wikimedia.org/wiki/File:Scuola_di_atene_01.jpg", sourceLabel: "Wikimedia Commons · Public Domain" },
  smith: { src: "/gallery/adam-smith.jpg", title: "Adam Smith", caption: "古典政治经济学的道德哲学背景。", sourceUrl: "https://commons.wikimedia.org/wiki/File:AdamSmith.jpg", sourceLabel: "Wikimedia Commons · Public Domain" },
};
